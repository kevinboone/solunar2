...
extern Festival *festival_new (time_t date, BOOL has_time, const char *name);
...
/** The comparator used for sorting lists of Festivals using klist_sort().*/
extern int       festival_sort_fn (const void *p1, const void *p2, 
                   void *user_data);
